...
public record SqlDraft(UUID id, long modifiedAt, String connectionId,
    ...
    public SqlDraft {
        if (id == null || modifiedAt < 0 || sql == null) throw new IllegalArgumentException("Invalid SQL draft value");
        if ((connectionId == null) != (connectionType == null)
                || (connectionId != null && connectionId.isBlank())
                || (connectionType != null && connectionType != DbType.POSTGRESQL && connectionType != DbType.ORACLE)) {
