...
- [ ] **Step 4: 在 runner 中先释放主 activation，再解析注释**
...
- [ ] **Step 4: 写 mandatory guard 选择和唯一 settlement 的 RED**
...
- [ ] **Step 6: 扩展 ManagedTabSpec 与 ContentTabPane**
...
- [ ] **Step 7: 写 SqlEditorPane mandatory close RED**
...
- [ ] **Step 8: 实现 SqlEditorPane mandatory close**
...
- [ ] **Step 9: 将 AppShell 退出接到 mandatory close-all**
